...
//*plan修改
$mux->get('/plan/edit', ['Mvc\Controller\Controller', 'editPlan']);
//*plan刪除
$mux->get('/plan/del', ['Mvc\Controller\Controller', 'delPlan']);
//*plan明細
$mux->get('/plan/lists', ['Mvc\Controller\Controller', 'listsPlan']);
//*plan單一明細
$mux->post('/plan/uniqueLists', ['Mvc\Controller\Controller', 'uniqueListsPlan']);
//*plan建立檢查
$mux->post('/insertCheck', ['Mvc\Controller\Controller', 'insertCheckPlan']);
//*item建立
